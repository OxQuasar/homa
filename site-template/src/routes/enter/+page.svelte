...
<svelte:head>
  <title>The Courtyard — Tar Valon</title>
  <meta name="description" content="A moonlit courtyard within the White Tower." />
</svelte:head>
...
<Hero
  ...
  alt="A stone courtyard with arches at night, lit by the moon"
...
<style>
  ...
  .side-link:hover {
    ...
    border-color: rgba(245, 241, 230, 0.9);
  }
</style>
