<script lang="ts">
  // Auth gate for /mysteries/modern-marvels/financial-markets/mev and
  // all child paths under the catch-all. Mirrors the I Ching research
  // gate exactly; only the page title differs.
...
<svelte:head><title>MEV Research — Tar Valon</title></svelte:head>
